<?php
class PerishablesController extends inventoryAppController {

	var $name = 'Perishables';
	var $uses = array('Inventory.Product','Inventory.Perishable', 'Inventory.ProductType','Inventory.Counter');
