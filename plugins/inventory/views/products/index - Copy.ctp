...
<div class="actions-container row-fluid animate" style="opacity: 100;">
...
<div class="tab w100">
	...
	<div class="canteen form formNeat w98 mCenter">
		...
		<div class="tab record metro nmLeft w100 mCenter">
			...
			<div class="tab-content off nmBottom ">
				<div class="fLeft w30 ">
							...
							<li class="mainInput">
								...
								<div class="fRight w45">
									...
									<div class="fRight w55 money ">
										...
										<div class="fRight w60 ">
											<div class="fLeft w80 VIEWavg">
												<?php echo $this->Form->input('Product.%.avg_price', array('label'=>false, 'readonly'=>'readonly','id'=>false,'class'=>'numeric monetary moreThanZero required',)); ?>
											</div>
											<div class="fLeft w20">
											</div>
											<div class="fClear"></div>
