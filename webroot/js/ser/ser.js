...
SER.Recordbook = function(_rc,_elem){
	...
	function newKey(obj){
		var hash ='';
		do{
			hash = SER.Crypto.md5(SER.Crypto.microtime()).substring(0,5);
		}while(obj[hash]);
		return hash;
	}
	return{
