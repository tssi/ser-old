...
<div class="row-fluid">
<div class="subjects form span6 offset3">
...
<?php echo $this->Form->create('Subject',array(	'class'=>'form-horizontal',
	...
	<fieldset>
		...
		<?php echo $this->Form->input('nomenclature',array('placeholder'=>'','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
		<?php echo $this->Form->input('description',array('placeholder'=>'','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
		<?php echo $this->Form->input('weight',array('placeholder'=>'','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
