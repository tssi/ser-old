...
<div class="row-fluid">
<div class="templateDetails form span6 offset3">

<?php echo $this->Form->create('TemplateDetail',array(	'class'=>'form-horizontal',
	...
	<fieldset>
		...
		<?php echo $this->Form->input('template_id',array('placeholder'=>'','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
