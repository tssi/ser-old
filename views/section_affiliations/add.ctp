...
<div class="row-fluid">
<div class="sectionAffiliations form span6 offset3">

<?php echo $this->Form->create('SectionAffiliation',array(	'class'=>'form-horizontal',
	...
	<fieldset>
		<legend><?php __('Add Section Affiliation'); ?></legend>
