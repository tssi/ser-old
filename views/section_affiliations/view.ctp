<div class="actions-container row-fluid animate">
 ...
 <div class="row-fluid">
<div class="span6">
<div class="sectionAffiliations view">
<h2><?php  __('Section Affiliation');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $sectionAffiliation['SectionAffiliation']['id']; ?>
			&nbsp;
		</dd>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $sectionAffiliation['SectionAffiliation']['esp']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Created'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $sectionAffiliation['SectionAffiliation']['created']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Modified'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $sectionAffiliation['SectionAffiliation']['modified']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
