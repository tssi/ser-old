...
<div class="row-fluid">
<div class="teachingLoads form span6 offset3">

<?php echo $this->Form->create('TeachingLoad',array(	'class'=>'form-horizontal',
	...
	<fieldset>
		<legend><?php __('Add Teaching Load'); ?></legend>
		<?php echo $this->Form->input('employee_id',array('placeholder'=>'','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
		<?php echo $this->Form->input('subject_id',array('placeholder'=>'','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
		<?php echo $this->Form->input('section_id',array('placeholder'=>'','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
		<?php echo $this->Form->input('class_type',array('placeholder'=>'','between'=>'<div class="controls">','after'=>'</div>' ,'class'=>'span11'));?>
